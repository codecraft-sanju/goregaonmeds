...
import { ArrowUpRight, ArrowLeft, Check, ChevronRight, Download, Eye, FileText, History, IndianRupee, LayoutDashboard, Loader2, LockKeyhole, LogOut, Plus, Printer, ReceiptText, Search, Send, ShieldCheck, Store, Trash2, Truck, X, RefreshCw } from 'lucide-react';
import { BRANCHES, MAX_DELIVERY_PAISE, money, newBill, newItem, totals, validate, validMoney, paise, type Bill, type Fulfilment, type Item } from './billing';
import { formatRupees } from '../storeSettings';
import './admin.css';
...
export default function AdminPanel() {
  ...
  function applySettings(data: unknown, syncInput: boolean) {
    const settings = data as { deliveryCharge?: unknown; updatedAt?: unknown } | null;
  ...
  function downloadImage() { 
    ...
    void task('Rendering receipt', async()=>{
      // Save first so a server-corrected delivery charge never ends up only in the downloaded image.
